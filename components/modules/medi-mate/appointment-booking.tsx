  ...
  return (
    <div className="space-y-6">
      <Tabs defaultValue="appointments" className="w-full">
        <TabsList className="grid grid-cols-2 mb-4 bg-gray-100 dark:bg-gray-800 transition-colors">
          <TabsTrigger value="appointments" className="data-[state=active]:bg-white dark:data-[state=active]:bg-gray-700 text-gray-900 dark:text-gray-100 transition-colors">My Appointments</TabsTrigger>
          <TabsTrigger value="nearby" className="data-[state=active]:bg-white dark:data-[state=active]:bg-gray-700 text-gray-900 dark:text-gray-100 transition-colors">Find Nearby</TabsTrigger>
        </TabsList>
